...
#/**ExtB HONGMI-55734,tianyuankang.wt,add,20190110,add simLock for Philippines,begin**/
ifneq ($(filter ro.miui.customized.region=ph_smart, $(subst @, ,$(BUILD_MIUI_CUSTOMIZED_PROP))),)
    CUSTOM_MODEM=MT6762_SP_LWCTG_6177M_CUSTOM_cactus_Philippines_simLock
else
    CUSTOM_MODEM=MT6762_SP_LWCTG_6177M_CUSTOM_cactus
endif
#/**ExtB HONGMI-55734,tianyuankang.wt,add,20190110,add simLock for Philippines,end**/
...
MTK_BUILD_VERNO = alps-mp-o1.mp6.tc8sp-V1_k62mv1.bsp_P287
MTK_BWC_SUPPORT = yes
...
WT_CT_REGISTER = yes
#-bug343175, wuwenting.wt, 20180309, add for ct register
#+ExtB-HONG50726, wanjinhua.wt, 20181011, add for Accuver XCa
